...
GLMM <- GLMM_Results %>% 
  dplyr::filter(Data_Type == "Calculated Value",
                `Dependent Variable` == "shannon_2005") |> 
  dplyr::select(`Independent Variable`, `F`, Df, Df.res, `Pr(>F)`) |> 
  dplyr::mutate(`F` = round(`F`, 3),
                `Pr(>F)` = round(`Pr(>F)`, 4),
                `Pr(>F)` = ifelse(`Pr(>F)` < 0.001, "< 0.001", as.character(`Pr(>F)`))) |> 
  dplyr::rename(`Df (res)` = Df.res, `P-Value` =`Pr(>F)`)
knitr::kable(GLMM)
```
...
Shannon_GLMM <- GLMM_Results %>% 
  dplyr::filter(Data_Type == "Calculated Value",
                `Dependent Variable` == "shannon_2005") %>% 
  dplyr::select(`Independent Variable`, `F`, Df, Df.res, `Pr(>F)`)
knitr::kable(Shannon_GLMM)
```

```{r Shannon Index Plots, warning=FALSE, message=FALSE, fig.height=8.5, fig.width=7.5}
p1 <- ggplot2::ggplot(Diversity, aes(x = Date, y = shannon_2005)) +
  ggplot2::geom_smooth(size = 1, aes(color = ReserveStatus, linetype = ReserveStatus),
...
p2 <- ggplot2::ggplot(Diversity, aes(x = Date, y = shannon_2005, color = IslandName)) +
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::geom_smooth(data = Diversity, 
                       aes(x = Date, y = shannon_2005, color = IslandName, linetype = ReserveStatus),
...
Diversity_Plot <-ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
Simpson_GLMM <- GLMM_Results %>% 
  ...
  dplyr::select(`Independent Variable`, `F`, Df, Df.res, `Pr(>F)`)
knitr::kable(Simpson_GLMM)
```

```{r Simpsons Index Plots, warning=FALSE, message=FALSE, fig.height=8.5, fig.width=7.5}
p1 <- ggplot2::ggplot(Diversity, aes(x = Date, y = simpson, linetype = ReserveStatus)) +
  ggplot2::geom_smooth(size = 1, aes(color = ReserveStatus)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
  ggplot2::scale_y_continuous(limits = c(.65, NA), expand = c(0, 0), oob = squish) +
  ggplot2::scale_color_viridis_d() +
  ggplot2::labs(x = NULL, y = NULL,
                linetype = "Reserve Status",
...
p2 <- ggplot2::ggplot(Diversity, aes(x = Date, y = simpson, color = IslandName)) +
  ggplot2::geom_smooth(size = 1) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
  ggplot2::scale_y_continuous(limits = c(.55, NA), expand = c(0, 0), oob = squish) +
  ggplot2::scale_color_viridis_d() +
  ggplot2::labs(x = NULL, y = NULL,
                color = "Island") +
  timeseries_top_theme()
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",                            
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Diversity, 
                       aes(x = Date, y = simpson, color = IslandName, linetype = ReserveStatus),
                       method = 'loess', formula = 'y~x', se = F) +
  ggplot2::geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
  ggplot2::scale_y_continuous(expand = expansion(mult = c(0.1, 0.1)),
                              limits = c(.50, NA), oob = squish) +
  ggplot2::guides(color = guide_legend(order = 1), 
                  linetype = guide_legend(order = 2, override.aes = list(col = 'black'))) +
  ggplot2::scale_color_viridis_d() +
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme() 
Simp_Diversity_Plot <-ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
Simp_Diversity_annotated <- ggpubr::annotate_figure(
  Simp_Diversity_Plot,
  left = text_grob("Simpson's Index (Diversity)", 
                   family ="Cambria", color = "black", rot = 90, size = 13)
)
...
ggplot2::ggplot() +
  ...
  ggplot2::geom_text(data = nMDS, size = 1.5, vjust = 2,
...
p1 <- ggplot2::ggplot(RPC_Cover_Wide, 
...
p2 <- ggplot2::ggplot(RPC_Cover_Wide, 
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
cysto_cover_Plot <- ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
cysto_cover_annotated <- ggpubr::annotate_figure(
  cysto_cover_Plot,
  left = text_grob(paste("Cystoseria sp. percent cover"),
...
Gari <- Original_16_rpcs_Data %>% 
  dplyr::filter(ScientificName == "Cystoseira") %>%
...
p1 <- ggplot2::ggplot(Gari, aes(x = Date, y = Percent_Cover, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Gari, size = 1,
              aes(x = Date, y = Percent_Cover, color = IslandName)) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0),
                        limits = c(base::as.Date("1982-01-01"), NA)) +
  ggplot2::scale_y_continuous(expand = expansion(mult = c(.1, 0)),
                              limits = c(0, NA), oob = squish) +
  ggplot2::scale_color_viridis_d() +
  ggplot2::guides(color = guide_legend(order = 1), 
...
Gari_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Gari_Orig16_annotated <- ggpubr::annotate_figure(
  Gari_Orig16_Plot,
  left = text_grob("Cystoseira sp. percent cover (%)",
                   color = "black", rot = 90, size = 12))
print(Gari_Orig16_annotated)
```
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Tetaur_Biomass_Plot <- ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot2::ggplot(Tetaur, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_label(aes(x = as.Date("2003-01-01"), y = Inf,
                          vjust = 1, hjust = 1, label = "New MPAs Created"), color = "black") +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
  ggplot2::scale_y_continuous(expand = expansion(mult = c(0, .1)),
                              limits = c(0, NA), oob = squish) +
  ggplot2::labs(title = NULL, subtitle = NULL,
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Tetaur, size = 1,
...
Tetaur_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8,1))
Tetaur_Orig16_annotated <- ggpubr::annotate_figure(
  Tetaur_Orig16_Plot,
  left = text_grob("Tethya aurantia biomass (g/m²)",
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
RedUrchin_Biomass_Plot <- ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot2::ggplot(Strfra, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) +
  ggplot2::geom_smooth(size = 1) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1,
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Strfra, size = 1,
              aes(x = Date, y = Mean_Biomass, color = IslandName)) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
...
Strfra_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Strfra_Orig16_annotated <- ggpubr::annotate_figure(
  Strfra_Orig16_Plot,
  left = text_grob("Strongylocentrotus franciscanus biomass (g/m²)", 
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Patmin_Biomass_Plot <- ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot2::ggplot(Patmin, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Patmin, size = 1,
              aes(x = Date, y = Mean_Biomass, color = IslandName)) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
...
Patmin_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Patmin_Orig16_annotated <- ggpubr::annotate_figure(
  Patmin_Orig16_Plot,
  left = text_grob("Patiria miniata biomass (g/m²)", 
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Kelp_Biomass_Plot <- ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
p1 <- ggplot2::ggplot(Macro, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1,
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Macro, size = 1, se = FALSE,
              aes(x = Date, y = Mean_Biomass, color = IslandName)) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0),
                        limits = c(base::as.Date("1984-01-01"), NA)) +
  ggplot2::scale_y_continuous(expand = expansion(mult = c(.1, 0)),
                              limits = c(0, NA), oob = squish) +
  ggplot2::scale_color_viridis_d() +
  ggplot2::guides(color = guide_legend(order = 1), 
...
Macro_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Macro_Orig16_annotated <- ggpubr::annotate_figure(
  Macro_Orig16_Plot,
  left = text_grob("Macrocystis pyrifera biomass (g/m²)", 
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
PurpleUrchin_Biomass_Plot <- ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
PurpleUrchin_Biomass_annotated <- ggpubr::annotate_figure(
  PurpleUrchin_Biomass_Plot,
  left = text_grob(glue("Lytechinus anamesus Biomass (g/m²)"), 
                   color = "black", rot = 90, size = 12))
...
p1 <- ggplot2::ggplot(Lytana, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Lytana, size = 1,
              aes(x = Date, y = Mean_Biomass, color = IslandName)) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0),
...
Lytana_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Lytana_Orig16_annotated <- ggpubr::annotate_figure(
  Lytana_Orig16_Plot,
  left = text_grob("Lytechinus anamesus biomass (g/m²)", 
                   color = "black", rot = 90, size = 12))
...
p1 <- ggplot2::ggplot(Strpur, aes(x = Date, y = Mean_Biomass, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1,
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = Strpur, size = 1,
              aes(x = Date, y = Mean_Biomass, color = IslandName)) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_hline(aes(yintercept = 0)) +
  ggplot2::scale_x_date(date_labels = "%Y", date_breaks = "year", expand = c(0, 0)) +
...
Strpur_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
Strpur_Orig16_annotated <- ggpubr::annotate_figure(
  Strpur_Orig16_Plot,
  left = text_grob("Strongylocentrotus purpuratus biomass (g/m²)", 
                   color = "black", rot = 90, size = 12))
...
p3 <- ggplot2::ggplot() +
  ...
  ggplot2::labs(x = "Survey Year", y = NULL,
                ...
                linetype = "Reserve Status") +
  timeseries_bottom_theme()
Sempul_Biomass_Plot <- ggpubr::ggarrange(p1, p2, p3, ncol = 1, align = "v", heights = c(.8, .8, 1))
...
SheepM <- Original_16_VFT_Data %>% 
  dplyr::filter(CommonName == "California sheephead, male") %>%
  dplyr::mutate(IslandName = gsub(" Island", "", IslandName)) %>%
  dplyr::mutate(IslandName = factor(IslandName, levels= IslandLevels)) %>%
  dplyr::mutate(Date = base::as.Date(base::ISOdate(SurveyYear, 1, 1)))

p1 <- ggplot2::ggplot(SheepM, aes(x = Date, y = Mean_Density, color = ReserveYear, linetype = ReserveYear)) + 
  ggplot2::geom_smooth(size = 1) +
  ggplot2::geom_vline(aes(xintercept = as.Date("2003-01-01")), size = 1) +
  ggplot2::geom_label(aes(x = as.Date("2003-01-01"), y = Inf, vjust = 1, 
                 hjust = 1, label = "New MPAs Created"), color = "black") +
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::scale_fill_viridis_c(
    ...
    guide = guide_colorbar(direction = "horizontal", title.position = "top",
                           order = 3, barheight = unit(.2, "cm"))) +
  ggplot2::geom_smooth(data = SheepM, size = 1, se = FALSE,
...
SheepM_Orig16_Plot <- ggpubr::ggarrange(p1, p2, ncol = 1, align = "v", heights = c(.8, 1))
SheepM_Orig16_annotated <- ggpubr::annotate_figure(
  SheepM_Orig16_Plot,
  left = text_grob("California sheephead male density (#/m³)",
                   color = "black", rot = 90, size = 12))
print(SheepM_Orig16_annotated)
```
...
KelpBass_Orig16_annotated <- ggpubr::annotate_figure(
  ...
  left = text_grob("kelp bass density (#/m³)",
                   color = "black", rot = 90, size = 12))
...
rwf_Orig16_annotated <- ggpubr::annotate_figure(
  rwf_Orig16_Plot,
  left = text_grob("rock wrasse female density (#/m³)",
                   color = "black", rot = 90, size = 12))
...
rwm_Orig16_annotated <- ggpubr::annotate_figure(
  rwm_Orig16_Plot,
  left = text_grob("rock wrasse male density (#/m³)",
                   color = "black", rot = 90, size = 12))
...
Pychel_Orig16_annotated <- ggpubr::annotate_figure(
  Pychel_Orig16_Plot,
  left = text_grob("Pycnopodia helianthoides biomass (g/m²)", 
                   color = "black", rot = 90, size = 12))
...
ggplot2::ggplot(Benthic_Biomass_Long, aes(x = SurveyYear, y = Mean_Biomass, fill = ScientificName)) +
  ...
  ggplot2::labs(title = NULL, x = "Survey Year", y = "Biomass (g/m²)", fill = "Scientific Name") +
